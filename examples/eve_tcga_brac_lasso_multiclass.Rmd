...
```{r, message=FALSE, echo=FALSE, warning=FALSE, fig.height=6}
...
# next door analysis is not available for multiclass lasso. Here is a temporary fix to rename variable names

colnames(df.vimp) <- gsub('coef','vimp', colnames(df.vimp))

...
1. Lasso does not output 'size', so the "number of feature used"" to train the model is not informative. 
Should check 'lambda' which is correspond to the number of features used.

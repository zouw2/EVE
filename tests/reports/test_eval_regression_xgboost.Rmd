---
title: "Evaluate testing data (regression) - xgboost"
author: "Andrew Chang"
date: '`r Sys.Date()`'
output:
  pdf_document:
...
```{r, echo=FALSE}
df.in <- df.preval %>% filter(seed == 1001, size == 41)
...
df.vimp.plt <- plotVIMP(df.vimp, bin = 50, ft_num = 41)
...
## vimp scatter plot
plotVIMP_scatter(df.vimp, top_n = 20, ft_num = 41)
```

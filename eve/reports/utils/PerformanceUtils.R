...
#' @param top_n_by size or freq. Select top_n features according to average coefficient size, or according to frequency of occurrence. Frequency may be preferred if X was not scaled.
